...
# ---------------------------------------------------------------------------
FUND_MAP = {
    # --- Verified SGD share-class symbols on Yahoo (SES). These are the best-match
    #     SGD class of each underlying fund; confirm against your ISIN before client use.
    #     yfinance pulls full daily history + 1y/3y/5y + last price + sector for these.
    "ZAGA": "0P0001MXXY.SI",   # Allianz Global Artificial Intelligence (SGD)
    "ZALC": "0P0001IL1V.SI",   # Allianz China A-Shares AT SGD
    "ZAIG": "0P0000Z32L.SI",   # Allianz Income and Growth AMi3 H2 SGD  (multiple SGD classes exist)
    "ZFSB": "0P0001D7HH.SI",   # First Sentier Bridge Fund (SGD)
    "ZSAG": "0P00006G0B.SI",   # Schroder Asian Growth SGD A Dis
    "ZJAE": "0P0000PRET.SI",   # JPMorgan ASEAN Equity A acc SGD
    "ZFDA": "0P00006ONO.SI",   # FSSA Dividend Advantage Fund (SGD)
    "ZFTF": "0P0001D6QQ.SI",   # Franklin Technology A Acc SGD-H1
    "ZFUO": "0P00009VEB.SI",   # Franklin US Opportunities A(acc) SGD
    "ZFIF": "0P00009VED.SI",   # Franklin Income A(Mdis) SGD-H1
    "PGIF": "0P0000Y077.SI",   # PIMCO GIS Income E SGD Hedged Inc

    # Add more the same way: search "<fund name> SGD yahoo finance 0P .SI" to find the
    # 0P....SI symbol, or paste an ISIN and the script auto-resolves it.
    # USD (Y...) classes: give the USD-class symbol or its ISIN.
}
